...
class Login extends Component {
  ...
  handleInputError = () => (this.state.errors.length > 0
                  ...
                  <form onSubmit={this.handleSubmit}>
                    <div className="flex-column-center">
                      <div className="form-group col-md-6  ">
                        ...
                        <input name="email" type="email" className={this.handleInputError(errors)} id="feEmailAddress" placeholder="Email" value={email} onChange={this.handleChange} />
                      </div>
                      <div className="form-group col-md-6" style={{ marginTop: 10 }} >
                        <label htmlFor="fePassword">Password</label>

                        <input name="password" type="password" className={this.handleInputError(errors)} id="fePassword" onChange={this.handleChange} value={password} placeholder="Password" /> </div>
                    </div>
